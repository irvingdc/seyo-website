...
import banner from "images/accesories/KIT_GOOGLE_TYR21/banner.jpg"
import google from "images/accesories/KIT_GOOGLE_TYR21/google.png"
import lock from "images/accesories/KIT_GOOGLE_TYR21/lock.png"
import gateway from "images/accesories/KIT_GOOGLE_TYR21/gateway.png"
...
const KEY_NAME = "KIT_GOOGLE_TYR21"

export default () => (
  <Layout
    productToPurchase={KEY_NAME}
    title={`Seyo | Productos - Kit De Apertura Remota Por Google Home con TYR21`}
    description="Abre la puerta al futuro, abre la puerta a SEYO."
    canonical="/otros-productos/kit-google-tyr21/"
  >
    <div className={classes.container}>
      <PreHeader type="h2" />
      <p><br /></p>
      <h1>Kit De Apertura Remota Por Google Home con TYR21</h1>
      <p><br /></p>
      <LockBanner
        img={banner}
        label="Incluye:"
      ...
      <FingerPrintFloor img={lock} hideExtraText hideTitle
        text={<p>
          Olvídate de las llaves con TYR21 tendras 6 métodos de apertura.
          <br />
          <br />
